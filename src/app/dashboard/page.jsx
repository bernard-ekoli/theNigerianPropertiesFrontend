...
export default function Dashboard() {
    ...
    useEffect(() => {
        async function fetchUserData() {
            try {
                ...
                console.log("This is the the body coming from the backend do well to make good use of it", body?.user?.role)
    ...
    // ⚠️ ADD Shield TO YOUR LUCIDE-REACT IMPORT:
    // import { ..., Shield } from 'lucide-react'
    //
    // All logic is untouched — only change is the isAdmin Admin button (2 places)
                    ...
                    <div className="header-content">
                        ...
                        <div className="header-left">
                            <Link href="/" className="brand">
                                <video src="/logoTest.mp4" autoPlay loop muted />
                            </Link>
                        </div>
                ...
                <div className="actions">
                    ...
                    <Link href="/dashboard/create-listing">
                        <button className="btn btn-primary">
                            <Plus className="icon-sm" /> Create New Listing
                        </button>
                    </Link>

                    <Link href="/properties">
                        <button className="btn btn-outline">
                            <Eye className="icon-sm" /> View All Properties
                        </button>
                    </Link>
                                ...
                                >
                                    ...
                                    <div className="listing-details">
                                        ...
                                        <div className="listing-header">
                                            ...
                                            <span
                                                className={
                                                    getStatusBadge(listing) === 'Expired'
                                                        ? 'expired-badge'
                                        ...
                                        <div className="listing-info">
                                            <div>
                                                <span><Bed className="icon-sm" /></span>
                                                <span>{listing.beds} Beds</span>
                                            </div>

                                            <div>
                                                <span><Bath className="icon-sm" /></span>
                                                <span>{listing.baths} Baths</span>
                                            </div>

                                            <div>
                                                <span><Square className="icon-sm" /></span>
                                    ...
                                    <div className="listing-actions">
                                        ...
                                        <button
                                            onClick={() => handleMessage(listing.id || listing._id)}
